...
public class Endpoints {
    ...
    public static final String GET_LABELS = "/projects/{project_id}/labels";
    public static final String CREATE_LABEL = "/projects/{project_id}/labels";
    ...
    public static final String GET_EPICS = "/projects/{project_id}/epics";
    public static final String CREATE_EPIC = "/projects/{project_id}/epics";
    public static final String DELETE_EPIC = "/projects/{project_id}/epics/{epic_id}";
}
